        ...
        <div className="space-y-1">
            ...
            <section className="py-10 bg-gradient-to-r from-white via-blue-50 to-white">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-12 sm:mb-16 text-[#0A92B9] animate-fadeInUp">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
                        {features.map(({ icon, title, description }, idx) => (
                            <div
                                key={idx}
                                className="bg-white p-6 sm:p-8 rounded-3xl shadow-lg flex flex-col items-center text-center space-y-4 sm:space-y-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-slideUp"
                                style={{ animationDelay: `${idx * 150}ms` }}
                            >
                                <div className="text-5xl sm:text-6xl">{icon}</div>
                                <h3 className="text-xl sm:text-2xl font-semibold text-[#C18440]">{title}</h3>
            ...
            <section className="py-10 bg-white">
                <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-8 sm:mb-10 text-[#0A92B9] animate-fadeInUp">
                        How It Works
                    </h2>
                    <p className="max-w-3xl mx-auto mb-12 sm:mb-16 text-base sm:text-lg text-gray-700 leading-relaxed animate-fadeInUp delay-150">
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-8 lg:space-x-12 space-y-8 md:space-y-0">
                        {steps.map(({ number, title, description }, idx) => (
                            <div
                                key={idx}
                                className="bg-blue-50 rounded-2xl p-6 sm:p-8 shadow-md flex-1 flex flex-col items-center text-center animate-slideUp"
                                style={{ animationDelay: `${idx * 200}ms` }}
                            >
                                <div className="text-5xl sm:text-6xl font-extrabold text-[#C18440] mb-5 sm:mb-6">{number}</div>
            ...
            <section className="py-10 bg-gradient-to-r from-[#0A92B9] to-[#087a9c] text-white text-center">
                <div className="max-w-4xl mx-auto px-6 sm:px-8 space-y-6">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold max-w-3xl mx-auto leading-tight">
                    ...
                    <form className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 max-w-xl mx-auto">
                        <input
                            type="email"
                            placeholder="Your email address"
                            required
                            className="w-full sm:flex-1 px-5 sm:px-6 py-3 sm:py-4 rounded-full text-gray-900 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-75 transition"
                        />
                        <button
                            type="submit"
                            className="bg-[#C18440] hover:bg-yellow-500 px-8 sm:px-10 py-3 sm:py-4 rounded-full font-semibold text-white shadow-lg transition duration-300 transform hover:scale-105"
                        >
                            Subscribe Now
                        </button>
                    </form>
            ...
            <section className="py-10 bg-white">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    ...
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 text-[#0A92B9] animate-fadeInUp">
                            Real Stories. Real Impact.
                        </h2>
                        <p className="text-gray-700 text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed animate-fadeInUp delay-150">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-12">
                        {[
                            ...
                            <div
                                key={idx}
                                className="bg-[#f9fafb] rounded-3xl shadow-lg p-6 sm:p-8 hover:shadow-2xl transform hover:-translate-y-3 transition duration-300 cursor-pointer animate-slideUp"
                                style={{ animationDelay: `${idx * 200}ms` }}
                            >
                                <img
                                    src={img}
                                    alt={name}
                                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover mx-auto mb-5 sm:mb-6 border-4 border-[#0A92B9]"
                                />
                                <h3 className="text-xl sm:text-2xl font-semibold text-center text-[#C18440] mb-3">{name}</h3>
                                <p className="text-center italic text-gray-700 mb-5 text-sm sm:text-base">{story}</p>
                                <ul className="text-xs sm:text-sm text-gray-500 space-y-1 text-center">
                                    <li>
                    ...
                    <div className="text-center mt-16 sm:mt-20">
                        <h4 className="text-xl sm:text-2xl font-semibold mb-5 text-gray-700">
                            Want to be featured here?
                        </h4>
                        <button className="bg-[#0A92B9] hover:bg-[#087a9c] text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full font-semibold shadow-lg transition duration-300 transform hover:scale-105">
                            Share Your Story
                        </button>
                    </div>
                </div>
            ...
            <section className="py-10 bg-gradient-to-r from-blue-50 to-white">
                <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-12 sm:mb-14 text-[#0A92B9] animate-fadeInUp">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        {faqs.map(({ question, answer }, idx) => (
                            <details
                                key={idx}
                                className="bg-white rounded-3xl shadow-lg p-5 sm:p-6 cursor-pointer group"
                                open={idx === 0} // প্রথম FAQ ডিফল্ট খোলা রাখতে চাইলে
                            >
                                <summary className="text-lg sm:text-xl font-semibold text-[#C18440] list-none flex justify-between items-center">
                                    {question}
                                    <svg
                                ...
                                <p className="mt-4 text-gray-700 leading-relaxed text-sm sm:text-base">{answer}</p>
                            </details>
                        ))}
                    </div>
                </div>
