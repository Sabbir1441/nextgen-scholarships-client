                ...
                {scholarships.map((scholarship) => (
                    <div key={scholarship._id} className="bg-white shadow-lg rounded-lg overflow-hidden transform transition-all hover:scale-105">
                        ...
                        <div className="p-6">
                            ...
                            <Link to={`/scholarship-details/${scholarship._id}`} className="inline-block text-white bg-blue-500 px-4 py-2 rounded-md hover:bg-blue-600">Scholarship Details</Link>
                        </div>
                    </div>
                ))}
            </div>
            <div className="text-center mt-8">
                <Link to="/all-scholarship" className="inline-block text-white bg-green-500 px-6 py-3 rounded-md hover:bg-green-600">See All Scholarships</Link>
            </div>
        </div>
    );
};
