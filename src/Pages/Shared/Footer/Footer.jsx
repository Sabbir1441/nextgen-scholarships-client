...
const Footer = () => {
  ...
  const handleSubscribe = (e) => {
    e.preventDefault();
    // Add subscription logic here (API call, validation, etc.)
    alert(`Subscribed with: ${email}`);
    setEmail("");
  };

  return (
    <footer className="bg-[#0A92B9] text-white pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-12">

        {/* Logo & About */}
        <div className="md:col-span-2 space-y-4">
          <h2 className="text-3xl font-bold tracking-tight">NextGen Scholarship</h2>
          <p className="text-gray-200 text-sm leading-relaxed">
            Empowering future leaders through transparent and reliable scholarship programs since 2015. Education changes lives — and we’re here to help you succeed.
          </p>
          <p className="text-gray-300 text-xs italic">
            Follow us on social media for latest updates and scholarship news.
          </p>
          <div className="flex space-x-5 mt-2">
            {/* Social Icons */}
            {[
              { href: "#", label: "Twitter", svgPath: "M23 3a10.9 10.9 0 0 1-3.14 1.53A4.48 4.48 0 0 0 22.4.36a9.05 9.05 0 0 1-2.83 1.08 4.52 4.52 0 0 0-7.86 3.1c0 .35.04.7.11 1.03A12.84 12.84 0 0 1 3.1 2.14a4.51 4.51 0 0 0-.61 2.27 4.51 4.51 0 0 0 2.01 3.75 4.48 4.48 0 0 1-2.05-.57v.06a4.53 4.53 0 0 0 3.63 4.44 4.52 4.52 0 0 1-2.04.08 4.53 4.53 0 0 0 4.22 3.14 9.05 9.05 0 0 1-5.59 1.92A9.32 9.32 0 0 1 1 19.54a12.79 12.79 0 0 0 6.92 2.03c8.3 0 12.84-6.88 12.84-12.84 0-.2-.01-.39-.02-.58A9.22 9.22 0 0 0 23 3z" },
              { href: "#", label: "Facebook", svgPath: "M22.675 0H1.325C.593 0 0 .6 0 1.337v21.326C0 23.4.593 24 1.325 24h11.494V14.7h-3.13v-3.6h3.13V8.7c0-3.1 1.892-4.8 4.658-4.8 1.325 0 2.464.098 2.797.143v3.24l-1.92.001c-1.505 0-1.797.715-1.797 1.763v2.31h3.587l-.467 3.6h-3.12V24h6.116C23.407 24 24 23.4 24 22.663V1.337C24 .6 23.407 0 22.675 0z" },
              { href: "#", label: "LinkedIn", svgPath: "M4.98 3.5c0 1.38-1.1 2.5-2.48 2.5C1.1 6 0 4.88 0 3.5S1.1 1 2.5 1 5 2.12 5 3.5zM.5 24h4V8h-4v16zM8.5 8h3.5v2.3h.05c.5-.94 1.75-1.95 3.6-1.95 3.85 0 4.55 2.53 4.55 5.8V24h-4v-8.3c0-2-.03-4.6-2.8-4.6s-3.25 2.2-3.25 4.5V24h-4V8z" },
        ...
        <nav aria-label="Quick Links" className="space-y-6">
          <h3 className="text-xl font-semibold border-b border-yellow-400 pb-2">Quick Links</h3>
          <ul className="space-y-3 text-sm">
            {['Home', 'Scholarships', 'About Us', 'Contact', 'FAQ'].map(link => (
              <li key={link}>
                <a
                  href="#"
        ...
        {/* Resources */}
        <nav aria-label="Resources" className="space-y-6">
          <h3 className="text-xl font-semibold border-b border-yellow-400 pb-2">Resources</h3>
          <ul className="space-y-3 text-sm">
            {['Blog', 'Events', 'Help Center', 'Privacy Policy', 'Terms & Conditions'].map(link => (
              <li key={link}>
                <a
                  href="#"
                  className="text-gray-300 hover:text-yellow-300 transition"
        ...
        {/* Contact & Newsletter */}
        <div>
          <h3 className="text-xl font-semibold border-b border-yellow-400 pb-2 mb-6">Contact & Newsletter</h3>
          <address className="not-italic text-gray-300 mb-6 space-y-2 text-sm">
            <p>📍 123 Knowledge Avenue, Dhaka, BD</p>
            <p>📞 +880-1234-567890</p>
            <p>✉️ support @nextgenscholar.org</p>
          </address>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-yellow-400 mt-16 pt-6 text-center text-sm text-yellow-200">
        <p>© 2025 NextGen Scholarship. All rights reserved.</p>
        <p className="mt-1">
          <a href="#" className="hover:underline">Privacy Policy</a> |{' '}
